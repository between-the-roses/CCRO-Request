  ...
  <body>
    ...
    <section class="hero-section container py-5 text-center text-md-start">
      <div class="row align-items-center">
        <div class="col-md-6">
          <h1 class="display-4 fw-bold">Iligan City <br />Civil Registry</h1>
          ...
          <p class="mt-4">
            ...
            convenient,<br />
            and hassle-free service — all from the comfort of your home.
          </p>
          <a href="#" class="btn btn-lg btn-primary mt-3" id="startButton"
            >Request Now</a
          >
        </div>
